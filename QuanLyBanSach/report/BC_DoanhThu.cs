...
namespace QuanLyBanSach.report {
    ...
    public class BC_DoanhThu : ReportClass {
    ...
    public class CachedBC_DoanhThu : Component, ICachedReport {
        
        public CachedBC_DoanhThu() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BC_DoanhThu rpt = new BC_DoanhThu();
            rpt.Site = this.Site;
            return rpt;
        }
